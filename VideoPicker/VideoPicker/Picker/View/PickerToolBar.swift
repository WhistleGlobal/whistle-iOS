...
extension PickerToolBar: PickerOptionsConfigurable {
  func update(options: PickerOptionsInfo) {
    ...
    leftButton.setTitleColor(options.theme[color: .whiteText], for: .normal)
    leftButton.setTitleColor(options.theme[color: .whiteText].withAlphaComponent(0.3), for: .disabled)
    doneButton.backgroundColor = options.theme[color: .primary]
    let normal = UIColor.create(
      style: options.theme.style,
      light: .white,
      dark: options.theme[color: .whiteText])
    let disabled = UIColor.create(
      style: options.theme.style,
      light: UIColor.white.withAlphaComponent(0.7),
      dark: options.theme[color: .whiteText].withAlphaComponent(0.3))
    ...
    originalButton.setTitleColor(options.theme[color: .whiteText], for: .selected)
    originalButton.setTitleColor(options.theme[color: .whiteText], for: .normal)
