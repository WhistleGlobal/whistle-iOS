...
class PreviewCell: UICollectionViewCell {
  ...
  /// 单击手势
  private(set) lazy var singleTap = UITapGestureRecognizer(target: self, action: #selector(onSingleTap))
  ...
  /// 设置 iCloud 下载进度
  func setDownloadingProgress(_ progress: Double) {
  ...
  func optionsDidUpdate(options _: PickerOptionsInfo) { }
}
...
extension Notification.Name {
  static let previewCellDidDownloadResource = Notification
    .Name("org.AnyImageKit.Notification.Name.Picker.PreviewCellDidDownloadResource")
}
