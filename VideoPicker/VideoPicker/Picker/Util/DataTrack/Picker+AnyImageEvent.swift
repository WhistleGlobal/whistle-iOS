...
extension AnyImageEvent {
  @available(
    *,
    deprecated,
    renamed: "pickerTakePhoto",
    message: "Will be removed in version 1.0, Please use `pickerTakePhoto` instead.")
  public static var takePhoto: AnyImageEvent { .pickerTakePhoto }

  @available(
    *,
    deprecated,
    renamed: "pickerTakeVideo",
    message: "Will be removed in version 1.0, Please use `pickerTakeVideo` instead.")
