...
extension AnyImagePage {
  ...
  @available(
    *,
    deprecated,
    renamed: "pickerAlbum",
    message: "Will be removed in version 1.0, Please use `pickerAlbum` instead.")
  ...
  @available(
    *,
    deprecated,
    renamed: "pickerAsset",
    message: "Will be removed in version 1.0, Please use `pickerAsset` instead.")
  public static var assetPicker: AnyImagePage { .pickerAsset }

  @available(
    *,
    deprecated,
    renamed: "pickerPreview",
    message: "Will be removed in version 1.0, Please use `pickerPreview` instead.")
