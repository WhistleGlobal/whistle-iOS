...
public struct PhotoLiveFetchOptions {
  ...
  public init(
    targetSize: CGSize = .init(width: 500, height: 500),
...
extension ExportTool {
  @discardableResult
  public static func requestPhotoLive(
    for asset: PHAsset,
    options: PhotoLiveFetchOptions = .init(),
    completion: @escaping PhotoLiveFetchCompletion)
    -> PHImageRequestID
  {
