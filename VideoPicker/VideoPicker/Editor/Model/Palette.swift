...
public enum Palette {
  ...
  public static var white: UIColor {
    UIColor.color(hex: 0xF2F2F2)
  }

  public static var black: UIColor {
    UIColor.color(hex: 0x2B2B2B)
  }

  public static var red: UIColor {
    UIColor.color(hex: 0xFA5151)
  }

  public static var yellow: UIColor {
    UIColor.color(hex: 0xFFC300)
  }

  public static var green: UIColor {
    UIColor.color(hex: 0x07C160)
  }

  public static var blue: UIColor {
    UIColor.color(hex: 0x10AEFF)
  }

  public static var purple: UIColor {
    UIColor.color(hex: 0x6467EF)
  }
  ...
  public static var textColors: [EditorTextColor] {
    [
      .init(
        ...
        shadow: Shadow(color: .black, alpha: 0.25, x: 0, y: 1, blur: 0.5, spread: 0)),
