...
extension AnyImageEvent {
  @available(
    *,
    deprecated,
    renamed: "editorPhotoBrush",
    message: "Will be removed in version 1.0, Please use `editorPhotoBrush` instead.")
  public static var photoPen: AnyImageEvent { .editorPhotoBrush }

  @available(
    *,
    deprecated,
    renamed: "editorPhotoMosaic",
    message: "Will be removed in version 1.0, Please use `editorPhotoMosaic` instead.")
  public static var photoMosaic: AnyImageEvent { .editorPhotoMosaic }

  @available(
    *,
    deprecated,
    renamed: "editorPhotoText",
    message: "Will be removed in version 1.0, Please use `editorPhotoText` instead.")
  public static var photoText: AnyImageEvent { .editorPhotoText }

  @available(
    *,
    deprecated,
    renamed: "editorPhotoCrop",
    message: "Will be removed in version 1.0, Please use `editorPhotoCrop` instead.")
