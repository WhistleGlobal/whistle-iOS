...
extension AnyImagePage {
  ...
  @available(
    *,
    deprecated,
    renamed: "editorPhoto",
    message: "Will be removed in version 1.0, Please use `editorPhoto` instead.")
  ...
  @available(
    *,
    deprecated,
    renamed: "editorVideo",
    message: "Will be removed in version 1.0, Please use `editorVideo` instead.")
  public static var videoEditor: AnyImagePage { .editorVideo }

  @available(
    *,
    deprecated,
    renamed: "editorInputText",
    message: "Will be removed in version 1.0, Please use `editorInputText` instead.")
