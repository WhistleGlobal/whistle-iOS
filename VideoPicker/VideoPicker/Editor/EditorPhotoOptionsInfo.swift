...
public struct EditorPhotoOptionsInfo {
  ...
  ///
  /// - Default: 2
  public var defaultBrushIndex = 2
  ...
  ///
  /// - Default: 2
  public var defaultMosaicIndex = 0
  ...
  ///
  /// - Default: true
  public var isTextSelected = true
  ...
  ///
  /// - Default: true
  public var calculateTextLastLineMask = true
...
extension EditorPhotoOptionsInfo {
  ...
  @available(
    *,
    deprecated,
    renamed: "brushColors",
    message: "Will be removed in version 1.0, Please use `brushColors` instead.")
  ...
  @available(
    *,
    deprecated,
    renamed: "defaultBrushIndex",
    message: "Will be removed in version 1.0, Please use `defaultBrushIndex` instead.")
