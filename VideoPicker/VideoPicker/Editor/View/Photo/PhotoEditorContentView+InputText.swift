...
extension PhotoEditorContentView {
  /// 单击手势
  @objc
  private func onTextSingleTap(_ tap: UITapGestureRecognizer) {
  ...
  /// 拖拽手势
  @objc
  private func onTextPan(_ pan: UIPanGestureRecognizer) {
  ...
  /// 捏合手势
  @objc
  private func onTextPinch(_ pinch: UIPinchGestureRecognizer) {
  ...
  /// 旋转手势
  @objc
  private func onTextRotation(_ rotation: UIRotationGestureRecognizer) {
...
// MARK: - PhotoEditorContentView + UIGestureRecognizerDelegate
...
extension PhotoEditorContentView: UIGestureRecognizerDelegate {
  ...
  {
    guard
      let view = gestureRecognizer.view as? TextImageView,
