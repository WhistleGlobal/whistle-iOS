...
extension EditorToolView: EditorBrushToolViewDelegate {
  func brushToolView(_: EditorBrushToolView, colorDidChange color: UIColor) {
    context.action(.brushChangeColor(color))
  }

  func brushToolViewUndoButtonTapped(_: EditorBrushToolView) {
...
extension EditorToolView: EditorMosaicToolViewDelegate {
  func mosaicToolView(_: EditorMosaicToolView, mosaicDidChange idx: Int) {
    context.action(.mosaicChangeImage(idx))
  }

  func mosaicToolViewUndoButtonTapped(_: EditorMosaicToolView) {
...
extension EditorToolView: EditorCropToolViewDelegate {
  func cropToolView(_: EditorCropToolView, didClickCropOption option: EditorCropOption) -> Bool {
  ...
  func cropToolViewResetButtonTapped(_: EditorCropToolView) {
    context.action(.cropReset)
  }

  func cropToolViewRotateButtonTapped(_: EditorCropToolView) -> Bool {
