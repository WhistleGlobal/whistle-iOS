...
//
//  func goPlayerNext() {
//    let index = min(max(0, currentVideoIndex), memberContentViewModel.memberFeed.count - 1)
//    if index == memberContentViewModel.memberFeed.count - 1 {
//      stopPlayer()
//      prevPlayer = nil
...
//      if memberContentViewModel.memberFeed[currentVideoIndex].isHated {
//        return
//      }
//      currentPlayer?.play()
//    } else {
...
//      currentPlayer = nextPlayer
//      nextPlayer = nil
//      nextPlayer = AVPlayer(url: URL(string: memberContentViewModel.memberFeed[index + 1].videoUrl ?? "")!)
//      currentPlayer?.seek(to: .zero)
//      if memberContentViewModel.memberFeed[currentVideoIndex].isHated {
//        return
//      }
