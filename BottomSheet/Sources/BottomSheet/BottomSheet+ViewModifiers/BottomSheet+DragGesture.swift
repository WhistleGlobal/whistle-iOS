...
extension BottomSheet {
  ...
  public func onDragChanged(_ perform: @escaping (DragGesture.Value) -> Void) -> BottomSheet {
    configuration.onDragChanged = perform
    return self
  }
  ...
  public func onDragEnded(_ perform: @escaping (DragGesture.Value) -> Void) -> BottomSheet {
    configuration.onDragEnded = perform
    return self
  }
  ...
  public func dragPositionSwitchAction(_ action: @escaping (
    GeometryProxy,
    DragGesture.Value) -> Void) -> BottomSheet
  {
    configuration.dragPositionSwitchAction = action
    return self
  }
}
