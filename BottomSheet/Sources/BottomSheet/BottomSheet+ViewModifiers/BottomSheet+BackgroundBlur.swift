...
extension BottomSheet {
  ...
  public func enableBackgroundBlur(_ bool: Bool = true) -> BottomSheet {
    configuration.isBackgroundBlurEnabled = bool
    return self
  }
  ...
  public func backgroundBlurMaterial(_ material: VisualEffect) -> BottomSheet {
    configuration.backgroundBlurMaterial = material
    return self
  }
}
