...
extension BottomSheet {
  ...
  public func customBackground(
    _ background: some View,
    alignment _: Alignment = .center)
    -> BottomSheet
  {
    configuration.backgroundView = AnyView(background)
    configuration.backgroundViewID = UUID()
    return self
  }
  ...
  public func customBackground(
    ...
    -> BottomSheet
  {
    configuration.backgroundView = AnyView(content())
    configuration.backgroundViewID = UUID()
    return self
  }
  ...
  public func customBackground(
    ...
    -> BottomSheet
  {
    configuration.backgroundView = AnyView(
      Rectangle()
        .fill(style)
