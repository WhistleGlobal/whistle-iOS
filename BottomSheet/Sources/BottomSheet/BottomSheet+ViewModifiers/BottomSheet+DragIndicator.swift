...
extension BottomSheet {
  ...
  public func showDragIndicator(_ bool: Bool = true) -> BottomSheet {
    configuration.isDragIndicatorShown = bool
    return self
  }
  ...
  public func dragIndicatorColor(_ color: Color) -> BottomSheet {
    configuration.dragIndicatorColor = color
    return self
  }
  ...
  public func dragIndicatorAction(_ action: @escaping (GeometryProxy) -> Void) -> BottomSheet {
    configuration.dragIndicatorAction = action
    return self
  }
}
