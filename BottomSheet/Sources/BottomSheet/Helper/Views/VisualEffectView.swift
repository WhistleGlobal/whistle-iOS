...
extension VisualEffect {
  ...
  fileprivate var blendingMode: NSVisualEffectView.BlendingMode {
    switch self {
    case .system, .systemLight, .systemDark:
      return .behindWindow
    case .adaptive(let material),
...
struct VisualEffectView: NSViewRepresentable {
  ...
  func makeNSView(context _: Context) -> NSVisualEffectView {
    ...
    view.material = visualEffect.material
    view.blendingMode = visualEffect.blendingMode
    view.appearance = visualEffect.appearance
  ...
  func updateNSView(
    ...
    context _: Context)
  {
    nsView.material = visualEffect.material
    nsView.blendingMode = visualEffect.blendingMode
    nsView.appearance = visualEffect.appearance
...
struct VisualEffectView: UIViewRepresentable {
  ...
  func makeUIView(context _: Context) -> UIVisualEffectView {
    let view = UIVisualEffectView(effect: UIBlurEffect(style: visualEffect.blurStyle))
    view.autoresizingMask = [
      .flexibleWidth,
      .flexibleHeight,
    ]
  ...
  func updateUIView(
    ...
    context _: Context)
  {
    uiView.effect = UIBlurEffect(style: visualEffect.blurStyle)
  }
}
#endif
